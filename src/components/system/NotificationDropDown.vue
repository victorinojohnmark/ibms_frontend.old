<template>
    <!-- Notifications -->
    <button type="button" @click="showDropDown = !showDropDown" @focusout="showDropDown = false"
    ...
    <!-- Dropdown menu -->
    <div class="block absolute right-0 top-10 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl" :class="{ 'hidden': !showDropDown }" @mouseleave="showDropDown = false">
        ...
        <div>
            <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="pl-3 w-full">
                    ...
                    <div class="text-xs font-medium text-green-600 dark:text-green-500">
                        a few moments ago
                    </div>
                </div>
            </a>
            ...
            <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="pl-3 w-full">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                        ...
                        <span class="font-medium text-green-600 dark:text-green-500">@bonnie.green</span>
                        what do you say?
                    </div>
                    <div class="text-xs font-medium text-green-600 dark:text-green-500">
                        1 hour ago
